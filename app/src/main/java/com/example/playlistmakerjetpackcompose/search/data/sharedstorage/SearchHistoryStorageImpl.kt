package com.example.playlistmakerjetpackcompose.search.data.sharedstorage
...
class SearchHistoryStorageImpl(private val sharedPreferences: SharedPreferences,private val gson: Gson) :
